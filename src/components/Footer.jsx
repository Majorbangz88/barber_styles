...
const Footer = () => {
  return (
    <div className="bg-black">
      <div className="max-w-[1400px] mx-auto px-6 md:px-10 lg:pt-30 xl:px-32">
        ...
        <div className='flex justify-between'>
              ...
              <div key={section.category} className='flex flex-col gap-10'>
                ...
                <ul className='flex flex-col gap-5'>
                  {section.items.map((item) => (
                      <li className='font-oswald text-gray-400 font-semibold' key={item}>{item}</li>
                  ))}
                </ul>
              </div>
            ))}
          ...
          <div className="flex flex-col gap-5 space-y-4">
            ...
            <div className="flex">
              ...
              />
              <button className="bg-[#d19f68] text-black px-4 py-2 rounded-r-md hover:bg-amber-600 transition-colors">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="flex border-t border-gray-800 mt-12 pt-6 text-gray-400 items-center justify-between">
          <p className=''>
